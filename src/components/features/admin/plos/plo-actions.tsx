...
export function PLOActions({ 
  ...
  const handleCopy = async () => {
    try {
      ...
      toast.success("Thông tin chuẩn đầu ra học phần đã được sao chép vào clipboard");
    } catch (error) {
  ...
  const handleExport = () => {
    ...
    toast.success("Thông tin chuẩn đầu ra học phần đã được xuất thành file JSON");
  };
